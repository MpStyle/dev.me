...
<div id="editor" class="row">
    <div id="source_textarea_container" class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
        <textarea id="source_textarea" class="form-control" placeholder="<?php echo $this->getSourceTextAreaPlaceholder() ?>"></textarea>
    </div>

    <div id="destination_textarea_container" class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
